...
PACKAGE ?= helm-argo-workflows
XRD_DIR := apis/argoworkflows
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/argoworkflows/standard.yaml
...
EXAMPLES := \
    examples/argoworkflows/minimal.yaml:: \
    examples/argoworkflows/standard.yaml::
...
render\:%:
	@example="examples/argoworkflows/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
